...
return [
    ...
    'Application not configured for two factor authentication.' => 'Aplikacja nieskonfigurowana dla uwierzytelniania dwuskładnikowego.',
    ...
    'Error while enabling SMS two factor authentication. Please reload the page.' => 'Wystąpił błąd w trakcie aktywowania uwierzytelniania dwuskładnikowego SMS. Prosimy o przeładowania strony.',
    ...
    'If you haven\'t received a password, you can reset it at' => 'Jeśli nie otrzymałeś hasła, możesz je zresetować na',
    ...
    'The email address set is: "{0}".' => 'Wybrany adres email to: "{0}".',
    'The email sending failed, please check your configuration.' => 'Wysyłanie emaila nie powiodło się, prosimy o weryfikację konfiguracji.',
    'The phone number set is: "{0}".' => 'Wybrany numer telefonu to: "{0}".',
    'The requested page does not exist.' => 'Szukana strona nie istnieje.',
    'The sms sending failed, please check your configuration.' => 'Wysyłanie SMS nie powiodło się, prosimy o weryfikację konfiguracji.',
    ...
    'This is the code to insert to enable two factor authentication' => 'To jest kod, którego wprowadzenie aktywuje uwierzytelnianie dwuskładnikowe',
    ...
    'User does not have sufficient permissions.' => 'Użytkownik nie posiada odpowiednich uprawnień.',
    ...
    'You cannot block your own account.' => 'Nie możesz zablokować własnego konta.',
    'You cannot remove your own account' => 'Nie możesz usunąć swojego włąsnego konta',
    'You cannot remove your own account.' => 'Nie możesz usunąć własnego konta.',
    'You need to confirm your email address' => 'Musisz potwierdzić swój adres email',
    'You received this email because someone, possibly you or someone on your behalf, have created an account at {app_name}' => 'Otrzymujesz ten email, ponieważ utworzyłeś (Ty lub ktoś w Twoim imieniu) konto na {app_name}',
    ...
    'Your consent is required to work with this site' => 'Twoja zgoda jest wymagana, aby używać tego serwisu',
    ...
    'Your attestation type is invalid and isn\'t supported.' => '',
    'Last Used At' => '',
    'expires in' => '',
    'rpId hash mismatch!' => '',
];
